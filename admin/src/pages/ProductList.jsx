...
useEffect(()=>{
    ...
    const columns = [
        ...
        { field: "products", headerName: "Products Name", width: 220 ,renderCell:(params)=>{
            return(
        ...
        }},
        {
          ...
          renderCell:(params)=>{
            return(
              <p>{format(params.row.createDate)}</p>
            )
          }
        },
        ...
        },
        {
            ...
            renderCell:(params)=>{
                return(
                    <>
                    <NavLink to={`/products/${params.row._id}`}>
    ...
    return (
        <div className='productslist' style={{ height: 600, width: "100%" }}>
        <DataGrid
          rows={data}
